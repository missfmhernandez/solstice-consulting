...
const experienceBrands = [
  { name: "Lloyds Bank", variant: "lloyds" },
  {
    name: "National Grid",
  ...
  { name: "Major Group", mark: "MAJOR", detail: "GROUP", compact: true },
  ...
  { name: "Hult Ashridge Executive Education", variant: "hult" },
];
    ...
    <main className="min-h-screen bg-anchor-cream text-anchor-ink">
          ...
          <aside className="rounded-[2rem] border border-anchor-ink/10 bg-white p-7 shadow-soft">
            <div className="flex items-center justify-between gap-6 border-b border-anchor-ink/10 pb-6">
              ...
              <div className="hidden rounded-full bg-anchor-sand p-4 sm:block">
                <ShieldCheck className="h-7 w-7 text-anchor-moss" />
              </div>
            </div>
            <div className="mt-7 grid gap-4">
              {outcomes.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  <CheckCircle2
                    className="mt-0.5 h-5 w-5 shrink-0 text-anchor-moss"
                    aria-hidden="true"
                  />
            ...
            {challenges.map((item) => (
              ...
              >
                <div className="space-y-6">
                  ...
                  <CardRow icon={Lightbulb} label="Solution" text={item.solution} />
                  <CardRow icon={TrendingUp} label="Outcome" text={item.outcome} />
                </div>
              </article>
            ))}
          </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {services.map(({ icon: Icon, title, text }) => (
            ...
            >
              ...
              <p className="mt-3 leading-7 text-anchor-muted">{text}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section id="partnerships" className="border-y border-anchor-ink/10 bg-white px-5 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-2">
            {partnerships.map(({ icon: Icon, challenge, solution, outcome }) => (
              <article
                key={challenge}
              ...
              >
                ...
                <div className="space-y-6">
                  <CardRow icon={Target} label="Challenge" text={challenge} strong />
                  <CardRow icon={Lightbulb} label="Solution" text={solution} />
                  <CardRow icon={TrendingUp} label="Outcome" text={outcome} />
                </div>
              </article>
            ))}
          </div>
      ...
      <section id="experience" className="border-y border-anchor-ink/10 bg-white px-5 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            text="Experience across global brands, growing organisations and high-performance environments."
          />

          <div className="mt-14 grid grid-cols-2 items-center gap-x-10 gap-y-12 text-anchor-ink md:grid-cols-3 lg:grid-cols-5">
          ...
          <p className="mt-10 text-sm font-semibold tracking-wide text-anchor-muted">
...
function CardRow({ icon: Icon, label, text, strong = false }) {
  return (
    <div>
      <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-sm font-semibold text-anchor-muted">
        <Icon className="h-4 w-4 text-anchor-clay" aria-hidden="true" />
        {label}
      </div>
      <p
        className={
    ...
    return (
      ...
      >
        ...
        <text
          x="100"
          y="63"
          className="fill-current text-[12px] font-bold uppercase tracking-[0.18em]"
        >
          ASHRIDGE EXEC ED
        </text>
      </svg>
